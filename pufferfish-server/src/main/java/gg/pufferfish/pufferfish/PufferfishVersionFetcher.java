...
public class PufferfishVersionFetcher implements VersionFetcher {
	...
	private static final URI JENKINS_URI = URI.create("https://ci.pufferfish.host/job/Pufferfish-26.1/lastSuccessfulBuild/buildNumber");
	private static final String GITHUB_FORMAT = "https://api.github.com/repos/pufferfish-gg/Pufferfish/compare/ver/26.1.2...%s";
